...
let logo1 = document.querySelector(".web-logo-1");
let logo2 = document.querySelector(".web-logo-2");
let Question1 = document.querySelector(".page3 .option-1");
let Question2 = document.querySelector(".page3 .option-2");
let expand1 = 0;
let expand2 = 0;
let open1 = 0;
...
logos.addEventListener("click" , function(){
  if(open1 == 0){
    ...
    <a href="./adventure.html" class="links"><h2 class="topic5">Events</h2></a>
  </div>`;
  ...
  open1 = 1;
    ...
    open1 = 0;
    logos.innerHTML = `<svg class="web-logo web-logo-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.655 543.64">
  <defs>
